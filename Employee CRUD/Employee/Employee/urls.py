...
from Employee_app.views import department_list_create_update_delete,position_list_create_update_delete,employee_list_create_update_delete,address_list_create,salary_list_create
